...
# Training set score: 0.99 for C = 100
# Test set score: 0.98 for C = 100

for C, marker in zip([0.001, 1, 100], ['o', '^', 'v']):
    lr_l1 = linear_model.LogisticRegression(C=C, penalty='l1', solver='liblinear').fit(X_train, y_train)
